  ...
  return (
    <div className="mywrapper w-full min-h-[968.26px] py-[75px] bg-white flex-col justify-center items-center gap-2.5 inline-flex">
      <div className="flex-col justify-start items-center gap-[70px] flex">
        ...
        <div className="w-[1170px] justify-start items-center gap-[31.08px] inline-flex">
          <div className="w-[369.28px] h-[465.26px] p-[9.14px] bg-white rounded-[9.14px] shadow flex-col justify-start items-start gap-[9.14px] inline-flex">
            <div className="h-[387.26px] flex-col justify-center items-center gap-[40.84px] flex">
              <img
                className="w-[203.84px] h-[203.84px]"
              ...
              <div className="flex-col justify-start items-center gap-[14.29px] flex">
                ...
                <div className="w-[290.67px] text-center text-slate-800 text-base font-medium font-['Bricolage Grotesque'] leading-tight">
                  Do you do an average of 13 jobs per quarter?
                </div>
                <div className="w-[290.67px] text-center text-neutral-600 text-sm font-normal font-['Bricolage Grotesque'] leading-[18.20px]">
          ...
          <div className="w-[369.28px] h-[465.26px] p-[9.14px] bg-white rounded-[9.14px] shadow flex-col justify-start items-start gap-[9.14px] inline-flex">
            <div className="h-[396.36px] flex-col justify-center items-center gap-[40.84px] flex">
              <img
                className="w-[203.84px] h-[212.94px]"
