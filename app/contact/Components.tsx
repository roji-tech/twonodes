export const ContactUs = () => {
  return (
    <div className="w-full min-h-[262px] py-[60px] bg-white flex-col justify-center items-center gap-2.5 inline-flex">
      <div className="self-stretch h-[142px] flex-col justify-start items-center gap-[45px] flex">
...
export const OurMap = () => {
  return (
    <div className="w-full min-h-[797px] py-24 bg-white justify-between items-center inline-flex">
      ...
      <img
        className="w-[657px] h-[605px] rounded-[10px]"
