...
const RevaDueDiligenceForm = ({ defaultData = {} }: { defaultData?: {} }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      authSaveFormDataAndInitiatePaystack(formData)
      ...
      notifyError("An error occurred while processing the form");
      setIsLoading(false);
    }
  };
  ...
  return (
    <LoadScript googleMapsApiKey={googleMapsApiKey} libraries={["places"]}>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Accuracy of{" "}
              <b className="text-red-500 text-lg">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel
              onClick={() => handleUseMyLocationFallback(false)}
            >
              Cancel
            </AlertDialogCancel>
      ...
      <div className="mx-auto p-6 sm:p-10 max-w-3xl w-full">
        {!showReview ? (
          <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-6 sm:p-10 space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  If address isn't available and you're at the property, use{" "}
              ...
              >
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Parcel ID:{" "}
                  <span className="text-gray-900 font-medium">{parcelId}</span>
                </p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-6 sm:p-10 space-y-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">{lga}</span>
              </div>
              <div>
                <span className="text-gray-600 block mb-1">Files:</span>
                <div className="space-y-1">
                  {fileNames.map((name, index) => (
                    <div key={index} className="text-gray-800 border-b text-sm">
                      {name}
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-4">
              <AlertDialog>
                <AlertDialogTrigger className="w-full">
                  <Button className="w-full bg-blue-600 text-white text-lg py-3 rounded-xl hover:bg-blue-700">
                    Confirm & Pay
                  </Button>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Please confirm that all details are accurate before
